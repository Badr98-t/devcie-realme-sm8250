...
function blob_fixup() {
    case "${1}" in
        ...
        odm/lib/libcodec2_soft_ozodec.so | odm/lib/libcodec2_soft_ozoenc.so | odm/lib/libozoc2store.so | system_ext/lib/libwfdavenhancements.so | system_ext/lib64/libwfdavenhancements.so)
